  ...
  auto cl =
      nb::class_<Chol>(
          ...
          .def(
              ...
              nb::arg("w"), nb::arg("sigma"), nb::rv_policy::reference)
#else
          .def(
              "rankUpdate",
              [](Chol &c, VectorType const &w, Scalar sigma) {
          ...
          .def(
              "reconstructedMatrix", &Chol::reconstructedMatrix,
...
// Expose is_approx for vectors too (exposed and tested for ùatrices only in
// eigenpy)
