...
template <typename MatrixType, typename MatrixOrVector1, typename MatrixOrVector2>
  ...
  auto cl = nb::class_<Solver>(m, name, 
               ...
               "iterations and NumTraits<Scalar>::epsilon() for the tolerance.\n")
                ...
                .def("setTolerance", &Solver::setTolerance,
                    ...
                    nb::rv_policy::reference)
                .def("preconditioner",                                                                 
                    [](Solver &c) -> Preconditioner& {          
                        return c.preconditioner();
                    },                                                                  
                ...
                .def("solveWithGuess",                                                                        
                     [](Solver const &c, VectorType const &b, VectorType const &x_0) -> VectorType { return solveWithGuess(c, b, x_0); },
                     nb::arg("b"), nb::arg("x_0"),
                     "Returns the solution x of A x = b using the current "
                     "decomposition of A.")
                .def("solveWithGuess",                                                                        
                     [](Solver const &c, MatrixType const &B, MatrixType const &X_0) -> MatrixType { return solveWithGuess(c, B, X_0); },
                     nb::arg("B"), nb::arg("X_0"),
                     "Returns the solution X of A X = B using the current "
                     "decomposition of A where B is a right hand side matrix.")
