...
// Wilson used to define the inetrmediate structures (eg EigenBaseVisitor) -> check if it works well here as I 
// defined, to be sure that ir is the appropriate solver that is called 
