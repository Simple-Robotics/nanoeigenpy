...
void exposePermutationMatrix(nb::module_ m, const char *name) {
  ...
  using PermutationMatrix = Eigen::PermutationMatrix<SizeAtCompileTime, 
                                                     MaxSizeAtCompileTime,
                                                     StorageIndex>;
  using VectorIndex = Eigen::Matrix<StorageIndex, SizeAtCompileTime, 1, 0,
                        MaxSizeAtCompileTime, 1>;

  auto cl = nb::class_<PermutationMatrix>(m, name, 
                "Permutation matrix.\n"
                ...
                .def("indices",
                    [](const PermutationMatrix &self) { return VectorIndex(self.indices()); },
                    "The stored array representing the permutation.")

                .def("applyTranspositionOnTheLeft", &PermutationMatrix::applyTranspositionOnTheLeft,
                nb::arg("i"), nb::arg("j"), 
                "Multiplies self by the transposition (ij) on the left.")                                               
                .def("applyTranspositionOnTheRight", &PermutationMatrix::applyTranspositionOnTheRight,
                nb::arg("i"), nb::arg("j"), 
                ...
                .def("setThreshold",
                    [](PermutationMatrix &self, Eigen::DenseIndex size) { self.setIdentity(size); },
                    nb::arg("size"), 
                ...
                .def("transpose",
                     [](PermutationMatrix const &self) -> PermutationMatrix { return self.transpose(); },
                     "Returns the tranpose permutation matrix.")
                .def("inverse",
                     [](PermutationMatrix const &self) -> PermutationMatrix { return self.inverse(); },
                     "Returns the inverse permutation matrix.")

                .def("resize", &PermutationMatrix::resize,
                     nb::arg("size"),
                ...
                .def("id",                                                                             
                     [](PermutationMatrix const &self) -> int64_t { return reinterpret_cast<int64_t>(&self); },
